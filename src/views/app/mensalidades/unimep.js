...
export default class Unimep extends Component {
  constructor() {
    super()
    this.state = {
      data: [],
  ...
  handleChange = event => {
    ...
    render() {
      ...
      const ie = "http://unimep.edu.br/"

        return (
            <Fragment>
            <Row>
              <Colxx xxs="7">
                <Breadcrumb heading="Universidade Metodista de Piracicaba" match={this.props.match} />
              </Colxx>
              <Colxx xxs="5">
